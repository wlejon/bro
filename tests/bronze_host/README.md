...
Twelve checks, run by hand. Exit codes are `0` pass, `1` fail, `77` skip.
...
**All twelve run the stock `bro-headless`** — the same binary every other test in
...
The last four are the newer half of the layer and are written to a stricter
