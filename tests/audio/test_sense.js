...
if (bro.sense.available === false) {
    ...
    console.log("test_sense: bro.sense is the unavailable stub; stub contract OK");
} else {
    // 1. Check API methods
