...
// bronze (embed::registerNative) under __bro_native.time. Hand-maintained: each
// registration's signature matches its prototype there. Call registerNatives_time from registerBroNatives
...
// prototype is published as __bro_native.time.<Class>Proto for js/bro_core.js to chain.
