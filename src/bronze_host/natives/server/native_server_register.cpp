...
// bronze (embed::registerNative) under __bro_native.server. Hand-maintained: each
// registration's signature matches its prototype there. Call registerNatives_server from registerBroNatives
...
// prototype is published as __bro_native.server.<Class>Proto for js/server.js to chain.
