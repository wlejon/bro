...
(function () {
        ...
        if (typeof c === 'string') {
            if (c.startsWith('#')) {
                if (c.length === 7) {
                    ...
                    return [parseInt(c[1] + c[1], 16) / 255, parseInt(c[2] + c[2], 16) / 255, parseInt(c[3] + c[3], 16) / 255];
                }
            }
    ...
    accessor(SceneNode.prototype, "x",
        function () { return __bro_native.scene.SceneNode_position_get(this)[0]; },
        function (v) {
            const p = Array.from(__bro_native.scene.SceneNode_position_get(this));
            p[0] = +v;
            __bro_native.scene.SceneNode_position_set(this, toF64(p));
        });
    accessor(SceneNode.prototype, "y",
        function () { return __bro_native.scene.SceneNode_position_get(this)[1]; },
        function (v) {
            const p = Array.from(__bro_native.scene.SceneNode_position_get(this));
            p[1] = +v;
            __bro_native.scene.SceneNode_position_set(this, toF64(p));
    ...
    accessor(SceneNode.prototype, "z",
        function () { return __bro_native.scene.SceneNode_position_get(this)[2]; },
        function (v) {
            const p = Array.from(__bro_native.scene.SceneNode_position_get(this));
            p[2] = +v;
            __bro_native.scene.SceneNode_position_set(this, toF64(p));
    ...
    accessor(SceneNode.prototype, "rotationX",
        function () { return __bro_native.scene.SceneNode_rotation_get(this)[0]; },
        function (v) {
            const r = Array.from(__bro_native.scene.SceneNode_rotation_get(this));
            r[0] = +v;
            __bro_native.scene.SceneNode_rotation_set(this, toF64(r));
        });
    accessor(SceneNode.prototype, "rotationY",
        function () { return __bro_native.scene.SceneNode_rotation_get(this)[1]; },
        function (v) {
            const r = Array.from(__bro_native.scene.SceneNode_rotation_get(this));
            r[1] = +v;
            __bro_native.scene.SceneNode_rotation_set(this, toF64(r));
    ...
    accessor(SceneNode.prototype, "rotationZ",
        function () { return __bro_native.scene.SceneNode_rotation_get(this)[2]; },
        function (v) {
            const r = Array.from(__bro_native.scene.SceneNode_rotation_get(this));
            r[2] = +v;
            __bro_native.scene.SceneNode_rotation_set(this, toF64(r));
        });
    accessor(SceneNode.prototype, "childCount",
        function () { return __bro_native.scene.SceneNode_childCount_get(this); },
        undefined);
    accessor(SceneNode.prototype, "type",
        function () { return __bro_native.scene.SceneNode_type_get(this); },
        undefined);
    accessor(SceneNode.prototype, "kind",
        function () { return __bro_native.scene.SceneNode_kind_get(this); },
        undefined);
    ...
    accessor(SceneNode.prototype, "metallic",
        function () {
            if (__bro_native.scene.SceneNode_type_get(this) !== 'mesh') return undefined;
            return __bro_native.scene.SceneNode_metallic_get(this);
        },
        function (v) { __bro_native.scene.SceneNode_metallic_set(this, +v); });
    accessor(SceneNode.prototype, "roughness",
        function () {
            if (__bro_native.scene.SceneNode_type_get(this) !== 'mesh') return undefined;
            return __bro_native.scene.SceneNode_roughness_get(this);
        },
        function (v) { __bro_native.scene.SceneNode_roughness_set(this, +v); });
    accessor(SceneNode.prototype, "emissive",
        function () {
            if (__bro_native.scene.SceneNode_type_get(this) !== 'mesh') return undefined;
            return __bro_native.scene.SceneNode_emissive_get(this);
        },
        function (v) { __bro_native.scene.SceneNode_emissive_set(this, +v); });
    accessor(SceneNode.prototype, "direction",
        function () { return Array.from(__bro_native.scene.SceneNode_direction_get(this)); },
        function (v) { __bro_native.scene.SceneNode_direction_set(this, toF64(v)); });
    accessor(SceneNode.prototype, "color",
        function () { return Array.from(__bro_native.scene.SceneNode_color_get(this)); },
        function (v) { __bro_native.scene.SceneNode_color_set(this, toF64(parseColor(v))); });
    accessor(SceneNode.prototype, "intensity",
        function () { return __bro_native.scene.SceneNode_intensity_get(this); },
        function (v) { __bro_native.scene.SceneNode_intensity_set(this, +v); });
    accessor(SceneNode.prototype, "range",
        function () { return __bro_native.scene.SceneNode_range_get(this); },
        function (v) { __bro_native.scene.SceneNode_range_set(this, +v); });
    accessor(SceneNode.prototype, "innerAngle",
        function () { return __bro_native.scene.SceneNode_innerAngle_get(this); },
        function (v) { __bro_native.scene.SceneNode_innerAngle_set(this, +v); });
    accessor(SceneNode.prototype, "outerAngle",
        function () { return __bro_native.scene.SceneNode_outerAngle_get(this); },
        function (v) { __bro_native.scene.SceneNode_outerAngle_set(this, +v); });
    ...
    accessor(SceneNode.prototype, "cascadeCount",
        function () { return __bro_native.scene.SceneNode_cascadeCount_get(this); },
        function (v) { __bro_native.scene.SceneNode_cascadeCount_set(this, v | 0); });
    accessor(SceneNode.prototype, "cascadeSplitLambda",
        function () { return __bro_native.scene.SceneNode_cascadeSplitLambda_get(this); },
        function (v) { __bro_native.scene.SceneNode_cascadeSplitLambda_set(this, +v); });
    ...
    fn(SceneGraph.prototype, "createLight", function createLight(opts) {
        ...
        if (d_opts.x !== undefined) node.x = d_opts.x;
        if (d_opts.y !== undefined) node.y = d_opts.y;
        if (d_opts.z !== undefined) node.z = d_opts.z;
        if (d_opts.direction !== undefined) node.direction = d_opts.direction;
        if (d_opts.color !== undefined) node.color = d_opts.color;
        if (d_opts.intensity !== undefined) node.intensity = d_opts.intensity;
        if (d_opts.range !== undefined) node.range = d_opts.range;
    ...
    fn(SceneGraph.prototype, "createTileWorld", function createTileWorld(opts) {
        ...
        return __bro_native.tile_world.createTileWorldJson(this, json);
    });
    ...
    fn(SceneGraph.prototype, "createMesh", function createMesh(opts) {
        let node;
        if (opts && opts.mesh && typeof opts.mesh !== 'string') {
            node = __bro_native.scene.SceneGraph_createMesh(this, JSON.stringify(opts || {}), opts.mesh);
        } else {
            node = __bro_native.scene.SceneGraph_createMesh(this, JSON.stringify(opts || {}), null);
        }
        if (opts) {
            if (opts.x !== undefined) node.x = opts.x;
            if (opts.y !== undefined) node.y = opts.y;
            if (opts.z !== undefined) node.z = opts.z;
            if (opts.position !== undefined) node.position = opts.position;
            ...
            if (opts.metallic !== undefined) node.metallic = opts.metallic;
            if (opts.roughness !== undefined) node.roughness = opts.roughness;
            if (opts.emissive !== undefined) node.emissive = opts.emissive;
            if (opts.castsShadow !== undefined) node.castsShadow = opts.castsShadow;
            if (opts.receivesShadow !== undefined) node.receivesShadow = opts.receivesShadow;
    ...
    fn(SceneGraph.prototype, "createShape", function createShape(opts) {
        return __bro_native.scene.SceneGraph_createShape(this, opts ? JSON.stringify(opts) : "");
    });
    fn(SceneGraph.prototype, "createSprite", function createSprite(opts) {
        return __bro_native.scene.SceneGraph_createSprite(this, opts ? JSON.stringify(opts) : "");
    });
    fn(SceneGraph.prototype, "createPhysicsNode", function createPhysicsNode(opts) {
        return __bro_native.scene.SceneGraph_createPhysicsNode(this, opts ? JSON.stringify(opts) : "");
    });
    fn(SceneGraph.prototype, "createParticles3D", function createParticles3D(opts) {
        return __bro_native.scene.SceneGraph_createParticles3D(this, opts ? JSON.stringify(opts) : "");
    });
    fn(SceneGraph.prototype, "createGaussianSplat", function createGaussianSplat(opts) {
        return __bro_native.scene.SceneGraph_createGaussianSplat(this, opts ? JSON.stringify(opts) : "");
    });
    fn(SceneGraph.prototype, "createSkinnedMesh", function createSkinnedMesh(opts) {
        return __bro_native.scene.SceneGraph_createSkinnedMesh(this, opts ? JSON.stringify(opts) : "", opts ? opts.mesh : null, opts ? opts.skin : null, opts ? opts.skeleton : null);
    });
    fn(SceneGraph.prototype, "createInstancedMesh", function createInstancedMesh(opts) {
        return __bro_native.scene.SceneGraph_createInstancedMesh(this, opts ? JSON.stringify(opts) : "", opts ? opts.mesh : null);
    });
    fn(SceneGraph.prototype, "toImageData", function toImageData() {
        const w = __bro_native.scene.SceneGraph_canvasWidth(this);
        const h = __bro_native.scene.SceneGraph_canvasHeight(this);
