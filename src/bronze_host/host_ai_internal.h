...
inline constexpr uint32_t kHostCommanderTag      = 0x434D4452u;  // 'CMDR'
...
inline constexpr uint32_t kHostTacticMctsTag     = 0x54414354u;  // 'TACT'
inline constexpr uint32_t kHostLayeredPlannerTag = 0x4C504C4Eu;  // 'LPLN'
inline constexpr uint32_t kHostSimulationTag     = 0x53494D55u;  // 'SIMU'
inline constexpr uint32_t kHostRecorderTag       = 0x52454344u;  // 'RECD'
inline constexpr uint32_t kHostReplayReaderTag   = 0x52504C59u;  // 'RPLY'
