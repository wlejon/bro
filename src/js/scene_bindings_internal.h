...
JSValue js_node_setTubeSegments(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv);
...
JSValue js_sg_setStarfield(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv);
