...
// There is no `bro.gamepad` namespace: poll with navigator.getGamepads(), and
// rumble through gamepad.vibrationActuator.playEffect('dual-rumble' |
// 'trigger-rumble', params).
